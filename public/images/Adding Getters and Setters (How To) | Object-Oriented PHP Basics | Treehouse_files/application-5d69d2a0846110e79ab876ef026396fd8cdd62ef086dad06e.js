(function() {
    ...
    return i(t, e), t.prototype.verifyEmailAddress = function() {
      ...
      $.ajax("/account/email_address", {
        ...
        error: (o = this, function(t) {
          var e;
          return $("#signupForm").find("button:contains('Join Now')").prop("disabled", !0), 
          o.unwrapErrors(i, r), o.clearFormErrors(i), i.siblings("label").wrap('<div class="field_with_errors" />'), 
          i.wrap('<div class="field_with_errors" />'), e = JSON.parse(t.responseText), i.after("<p class='error-message'>" + e.error + "</p>");
        }),
        success: function(t) {
          return function() {
            if ($("#signupForm").find("button:contains('Join Now')").prop("disabled", !1), t.unwrapErrors(i, r), 
            null == i.val()) return t.clearFormErrors(i);
          };
        }(this)
      });
  ...
  Treehouse.CreditCardTokenizer = function() {
    ...
    return e.prototype.tokenizeCard = function(t, e, i, r, s) {
...
//# sourceMappingURL=/assets/maps/application-414af88cd6be2387590ff43aa22a1196d4f431b4e5b05ebc23e66cea80aebca8.js.map
